...
if (isset($_POST['saveImg'])) {
    ...
    $old_file_path = "../../img/users/" . $_SESSION["user_data"]["profile_img"];
                        ...
                        <div class="py-2 d-flex justify-content-center">
                            <form enctype="multipart/form-data" method="post" action="myAccount.php">
                                <div class="profile-picture">
                                    ...
                                    <img id="img-output" src="<?php echo "../../img/users/" . (empty($_SESSION["user_data"]["profile_img"]) ? "default.jpeg" : $_SESSION["user_data"]["profile_img"]); ?>" alt="profile picture" />
                                </div>
