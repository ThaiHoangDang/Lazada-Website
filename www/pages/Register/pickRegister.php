                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <a href="customerRegister.php" class="btn btn-primary">Register as customer</a>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <a href="vendorRegister.php" class="btn btn-primary">Register as vendor</a>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <a href="shipperRegister.php" class="btn btn-primary">Register as shipper</a>
                            </div>
                        </div>
                    </div>
                </div>
